...
(ターミナルの出力)
```
C:\Users\XXXX\precure_reproduct>g++ test.cpp -I .
...
(ターミナルの出力)
```
C:\Users\XXXX\precure_reproduct>g++ main.cpp CureNabefuta.cpp  -I . 

C:\Users\XXXX\precure_reproduct>a.exe
num :6
NA
action! (6)
```
...
```
C:\Users\XXXX\precure_reproduct>g++ main.cpp -I .
c:/mingw/bin/../lib/gcc/mingw32/9.2.0/../../../../mingw32/bin/ld.exe: C:\Users\YYYY\ccw8ehrF.o:main.cpp:(.text+0x23): undefined reference to `Cure::Nabefuta::Nabefuta(int)'
c:/mingw/bin/../lib/gcc/mingw32/9.2.0/../../../../mingw32/bin/ld.exe: C:\Users\YYYY\ccw8ehrF.o:main.cpp:(.text+0x2b): undefined reference to `Precure::action()'
c:/mingw/bin/../lib/gcc/mingw32/9.2.0/../../../../mingw32/bin/ld.exe: C:\Users\YYYY\ccw8ehrF.o:main.cpp:(.text+0x36): undefined reference to `Precure::action(Cure::Nabefuta&)'
